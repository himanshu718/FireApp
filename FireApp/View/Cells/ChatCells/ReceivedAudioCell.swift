...
class ReceivedAudioCell: ReceivedBaseCell, AudioBase {
    ...
    override func bind(message: Message,user:User) {
        ...
        currentDuration.isHidden = message.downloadUploadState != .SUCCESS
